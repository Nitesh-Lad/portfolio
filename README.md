...
![Portfolio Demo](https://i.postimg.cc/43f4GH4z/portfolio_nits.png)
...
[**Live Demo**](https://portfolio-niteshlad.vercel.app/)
---
### 🎯 Project Structure
```bash
portfolio/
...
2. After forking, open your terminal and run the following commands to clone the repo:
  ...
  ```bash
  git clone https://github.com/Nitesh-Lad/portfolio.git
  ```
...
<div align="center"> Made with ❤️ by Nitesh Lad </div>
