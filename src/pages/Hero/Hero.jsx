...
const profile = {
    name: 'Nitesh Lad',
    title: 'Full-Stack Developer | Python Developer | Problem Solver',

    skills: ['Python', 'Java', 'Data Structures',
        'MySQL', 'MongoDB', 'AI & ML', 'Docker', 'AWS',
        'React', 'NextJS', 'Express', 'Git', 'Linux'],
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Python Enthusiast 🐍 | Web Developer 🌐 | Problem Solver 💡| Building Real-World Projects 💻 |
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Nitesh-Lad"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/13ivyGB3u4VG4YojBtTp-x5BSX1e_QlP6/view?usp=sharing"
